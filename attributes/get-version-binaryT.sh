...
### region ############################################ DOCBLOCK
#
# Tests for version of a binary, as configured below.  Note that the BINARY_NAME and VERSION_FLAG
# must be customized for each binary, and should be tested on the command line before implementing.
#
...
DEFAULT="None"
BINARY_NAME=""
VERSION_FLAG="" # Required: Include single or double dashes as applicable
VERSION_GREP="" # Optional: Cuts to only the lines that include this result
VERSION_LINE="" # Optional: Only includes the given line number
VERSION_COLUMN="" # Optional: Cuts to this space delimited column of the results
VERSION_PIPE="" # Optional: Additional string manpulation.  Do not include leading pipe!!

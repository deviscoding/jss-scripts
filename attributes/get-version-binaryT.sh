...
### region ############################################ DOCBLOCK
#
# Tests for version of a binary, as configured below.  Note that the BINARY_NAME, VERSION_FLAG, and VERSION_PIPE
...
DEFAULT="None"
BINARY_NAME=""
VERSION_FLAG="" # Include single or double dashes as applicable
